...
class rpiTurntable(ScannableBase):
    def __init__(self, name):
        print "constructing turntable"
...
#        print self.speed
    ...
    def asynchronousMoveTo(self,new_position):
        #print "moving turntable from ",self.currentPosition, "to ", new_position
        degreesMove = int(new_position) - int(self.currentPosition)
        #print degreesMove
        stepsMove = float(2048)/float(360)*float(degreesMove)
        #print stepsMove
        os.system("python /home/pi/testscripts/stepper3.py " + "10 " + str(stepsMove))
